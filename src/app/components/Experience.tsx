    ...
    <>
      <div className="exp-container">
        ...
        <ExperienceCard
          ...
          image="/timeline/readwise.png"
          about={readwiseabout}
          lessons={readwiselessons}
        />
        <ExperienceCard
          title="Backend Engineer with OPS"
          techstack={[
            "Spring Boot",
            "Angular",
            "Java",
